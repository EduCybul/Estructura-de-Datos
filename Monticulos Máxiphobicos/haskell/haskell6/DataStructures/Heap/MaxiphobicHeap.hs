...
h1 :: Heap Char
h1 = Node 'a' 6 (Node 'd' 3 (Node 'e' 1 Empty Empty)(Node 'f' 1 Empty Empty))(Node 'b' 2 (Node 'c' 1 Empty Empty)Empty)
...
merge h@(Node x sz lh rh) h'@(Node x' sz' lh' rh')
 | x < x'          = Node x sz' h' (merge lh rh)
 | otherwise       = Node x' sz h (merge lh' rh')
----------------------------------------------------------
-- ^^^^^^^^^^^^^^-- SOLO TOCAR ARRIBA ^^^^^^^^^^^ ---------
----------------------------------------------------------
